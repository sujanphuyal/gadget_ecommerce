                                    ...
                                    <div class="category">
                                        ...
                                        <div class="fr__hover__info">
                                            <ul class="product__action">
                                                ...
                                                <!-- <li><a href="javascript:void(0)" onclick="manage_cart('<?php echo $list['id'] ?>','add')"><i class="fa fa-shopping-cart icons"></i></a></li> -->
                                            </ul>
                                        </div>

                                        <div class="fr__product__inner">
                                            <h4><a href="product.php?id=<?php echo $list['id'] ?>"><?php echo $list['product_name'] ?></a>
                                            </h4>
                            ...
                            <div class="col-md-4 col-lg-3 col-sm-4 col-xs-12">
                                <div class="category">
                                    ...
                                    <div class="fr__product__inner">
                                        ...
                                        <ul class="fr__pro__prize">
                                            <li class="old__prize">MRP<br />Rs&nbsp;<?php echo $list['mrp'] ?></li>
                                            &nbsp;&nbsp;&nbsp;
                                            <li>Price<br />Rs&nbsp;<?php echo $list['price'] ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
